...
const DESCRIPTIONS: Partial<Record<AdminTab, string>> = {
  ...
  brands: "Ana sayfada gösterilen marka logoları ve bayilikler.",
  slider: "Ana sayfa hero slider görselleri ve içerikleri.",
  media: "Web sitesinde kullanılan tüm görsellerin kütüphanesi.",
  messages: "Web sitenizden gelen iletişim mesajları.",
  quotes: "Web sitesinden gelen teklif talepleri.",
