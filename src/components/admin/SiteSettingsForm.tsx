...
const FIELDS: { name: string; label: string; type?: "textarea" | "url" }[] = [
  ...
  { name: "description", label: "Kısa Tanım (SEO)", type: "textarea" },
  { name: "google_search_console", label: "Search Console Doğrulama Kodu (HTML tag içindeki content değeri)" },
  ...
  { name: "logo_url", label: "Ana Logo URL", type: "url" },
  { name: "favicon_url", label: "Favicon URL (Opsiyonel)", type: "url" },
